...
import { ChargeVoucherVO, ChargeVoucherForm, ChargeVoucherQuery } from '@/api/kp-system/chargeVoucher/types';
...
export const listChargeVoucher = (query?: ChargeVoucherQuery): AxiosPromise<ChargeVoucherVO[]> => {
  return request({
    url: '/kp-system/chargeVoucher/list',
    method: 'get',
    params: query
  });
};
...
export const getChargeVoucher = (id: string | number): AxiosPromise<ChargeVoucherVO> => {
  return request({
    url: '/kp-system/chargeVoucher/' + id,
    method: 'get'
  });
};
