    ...
    <el-card shadow="never">
      <template #header>
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['kpSystem:chargeAccount:add']">新增</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate()" v-hasPermi="['kpSystem:chargeAccount:edit']">修改</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete()" v-hasPermi="['kpSystem:chargeAccount:remove']">删除</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['kpSystem:chargeAccount:export']">导出</el-button>
          </el-col>
      ...
      <el-table v-loading="loading" :data="chargeAccountList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="最近一次访问时间" align="center" prop="lastVisitTime" width="180">
          <template #default="scope">
        ...
        <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
          <template #default="scope">
            <el-tooltip content="修改" placement="top">
              <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['kpSystem:chargeAccount:edit']"></el-button>
            </el-tooltip>
            <el-tooltip content="删除" placement="top">
              <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['kpSystem:chargeAccount:remove']"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
...
/** 导出按钮操作 */
const handleExport = () => {
  proxy?.download('kpSystem/chargeAccount/export', {
    ...queryParams.value
